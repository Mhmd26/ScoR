...
async def stsfanan(lon):
    ...
    if sts_fanan4:
        tumc = f""
        tumc += f"**✎┊‌ ثيم شكل محادثة واتساب دقة عالية 💚**\n"
...
async def stsfanan(zed):
    ...
    if sts_fanan9:
        tumc = f""
        tumc += f"**✎┊‌ ثيم خيال علمي لون داكن 4k 🌆**\n"
