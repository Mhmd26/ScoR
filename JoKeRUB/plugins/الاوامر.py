...
async def _(event):
        if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
                await event.edit(
                "** الحساب والتلكراف | 𝗔𝗰𝗰𝗼𝘂𝗻𝘁 𝗼𝗿𝗱𝗲𝗿𝘀 ✍🏻**:\n \n ** إختر إحداها : **\n\n**- { `.اوامر الحساب` }**\n**- { `.تصفية الحساب` }**\n**- { `.اوامر الحماية` }**\n**- { `.اوامر التلكراف` }** \n \n **[العقرب | 𝐒𝐜𝐨𝐫𝐩𝐢𝐨𝐧 ](t.me/Scorpion_scorp)☑️**"
)
@l313l.ar_cmd(
    pattern="م4$",
