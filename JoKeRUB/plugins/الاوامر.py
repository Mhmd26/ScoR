...
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        ...
        await event.edit(
        f" ****\n===========================           [قائمة اوامر العقرب | 𝗦𝗰𝗼𝗿𝗽𝗶𝗼 𝗼𝗿𝗱𝗲𝗿𝘀](t.me/Scorpion_scorp) ✍🏻\n( `.م1`  )  ⦙ **أوآمِر الآدمِنْ**\n( `.م2`  )  ⦙ **أوآمِر المَجمُوعَة**\n( `.م3`  )  ⦙ **ألتَرحِيبُ وٱلرُدود**\n( `.م4`  )  ⦙ **حِمآيَة ٱلخَاصُ وٱلتِلِگراف**\n( `.م5`  )  ⦙ **المِنشنُ وٱلأنتِحال**\n( `.م6`  )  ⦙ **النُطْقُ وَ ٱلتَحمِيل **\n( `.م7`  )  ⦙ **أوآمِرُ ٱلمَنعُ وَ ٱلقُفل **\n( `.م8`  )  ⦙ **أوآمِر التَنظِيفُ وَ ٱلتِكرَآر**\n( `.م9`  )  ⦙ **أوآمِر الكِتآبَة وَ النَشرْ**\n( `.م10` ) ⦙ **ألوَقتِي وَٱلتَشغِيل**\n( `.م11` ) ⦙ **ألكَشفُ وَٱلرَوابِط**\n( `.م12` ) ⦙ **الإرسَالُ وَالأذكَار**\n( `.م13` ) ⦙ **أوآمِر المُلصَقآت وَ الإستِخرَاج**\n( `.م14` ) ⦙ **أوآمِر التَسلِية وَ المِيمْز** \n( `.م15` ) ⦙ **أوَآمر التَحوِيل وَٱلإضآفة**\n( `.م16` ) ⦙ **أوَآمِر التَمبِلر والزَخرَفة**\n( `.م17` ) ⦙ **أوآمِر ٱلحِسآب وَالتَرفِيه**\n( `.م18` ) ⦙ **حِسَاباتٌ وَهمِية وَإستِنسآخ**\n( `.م19` ) ⦙ **أوآمِر تَجمِيع ٱلنُقاط**\n( `.م20` ) ⦙ **أوآمِر الثِيمآت وَالصُور**\n( `.م21` ) ⦙ **أفَتآراتْ وَأوآمِر مُنَوَعة **\n( `.م22` ) ⦙ **ألقُرْآن ألكَرِيمْ وَٱلأحَآدِيثْ **\n( `.م23` ) ⦙ **قِسْمُ ٱلذَكآء الإصطِناَعِي ****    {Zo_r0} **"
)
