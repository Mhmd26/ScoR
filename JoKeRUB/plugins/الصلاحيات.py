...
async def _(event):  # sourcery no-metrics
    ...
    if not current_db_locks:
        res = "**- لا توجد معلومات كافيه في هذه الدردشة **\n"
    else:
        res = "**✎┊‌ ملـف الاوامر مقدم من سورس العقرب:** \n"
    ...
    try:
        ...
        res += f" **✎┊‌ تغيير معلومات المتحركة:** `{uchangeinfo}`\n"
